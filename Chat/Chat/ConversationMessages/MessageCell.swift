...
//		messageLabel.leftAnchor.constraint(equalTo: backView.leftAnchor, constant: self.contentView.frame.width * 0.25).isActive = true
		messageLabel.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -10).isActive = true
//		messageLabel.rightAnchor.constraint(equalTo: backView.rightAnchor).isActive = true
