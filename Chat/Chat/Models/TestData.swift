...
struct TestData {
	static let lastNames = ["Walker", "Carter", "Morris",
							"Ramirez", "Barnes", "Simmons",
							"Gray", "Campbell", "Lee",
							"Brown", "James", "Kelly",
							"Perry", "Henderson", "Gray",
							"Parker", "Bennett", "Williams",
							"Hayes", "Wilson", "Powell",
							"Davis", "Rodriguez", "Henderson",
							"Long", "Evans", "Patterson",
							"Stewart", "Hill", "Cox",
							"Foster", "Cooper", "Martinez",
							"Parker", "Johnson", "Williams",
							"Mitchell", "Barnes", "Allen",
							"Gonzales", "Price", "Patterson",
							"Cox", "Murphy", "Gray",
							"Flores", "Rodriguez", "Martinez",
							"Wright", "Perez"]
	
	static let firstNames = ["Armando", "Bronson", "Bryson",
							 "Dante", "Dominic", "Everett",
							 "Hugo", "Isaak", "Issac",
							 "Jace", "Kenley", "Knox",
							 "Milo", "Octavio", "Osiris",
							 "Ozzy", "Quinten", "Ricardo",
							 "Roman", "Roy", "Westley",
							 "Xavion", "Yehoshua", "Yousef",
							 "Zechariah", "Ruth", "Paula",
							 "Wilfreda", "Zaida",
							 "Undine", "Clara", "Orabelle",
							 "Yuki", "Laila",
							 "Viktoria", "Vanessa", "Selena",
							 "Thea", "Xanthia",
							 "Fabiana", "Heidy", "Janelle",
							 "Belen", "Bianca", "Praise",
							 "Elaina", "Cali", "Skyla",
							 "Veronika", "Zaira"]
	
	static let context = ["Да", "Ок",
						  "Как дела? \nЧто делаешь?", "В порядке",
						  "Вчера был в аду\nСам как?", "Не знаю",
						  ...
						  "Это не точно", "Да как так то?!?",
						  "У тебя юудут проблемы, точно говорю",
						  "В пол 5\n Или 6\n Посмотрим", "Ботинок", "Сам такой\nОбидка",
						  "Дурень\nВсе только начинается", "Где-то",
						  "Не хочу говорить\nПозднее может",
						  "Ну так то да, такое себе",
						  "Я дома\nНе занят", "Да\nНет",
						  "Во сколько?\nЯ подумаю\nТочно надо?\nЯ просто занят",
						  "Выходи", "Вышел", "А у тебя есть?", "Ага))",
						  "Не точно\nНу был там, да", "Я в столовке\nТебе взять еды?",
						  "Если пойдешь еще раз, то меня позови", "Привет!", "Здоров"]
	...
	static let users = [User(firstName: "Sergey",
							 lastName: "Gryaznov",
							 messages: [Message(body: "My test message",
												date: Date(timeInterval: 10, since: Date()),
												unread: true,
												ownerID: User.idGenerator)],
							 online: true),
